...
class User extends Authenticatable
{
    ...
    /**
     * Get the permissions for this user through roles.
     */
    ...
    public function hasPermission($permission)
    {
        ...
        // Check direct permissions field (legacy)
        if ($this->permissions && in_array($permission, is_array($this->permissions) ? $this->permissions : $this->permissions->toArray())) {
            return true;
        }
