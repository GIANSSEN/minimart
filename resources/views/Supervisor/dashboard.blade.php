            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        @endif
                        <div class="col-md-3 mb-2">
                            <a href="{{ route('admin.brands.index') }}" class="btn btn-outline-primary btn-lg w-100 py-3">
                                <i class="fas fa-trademark me-2"></i>Manage Brands
                            </a>
                        </div>
                        <div class="col-md-3 mb-2">
                            <a href="{{ route('admin.suppliers.index') }}" class="btn btn-outline-info btn-lg w-100 py-3">
