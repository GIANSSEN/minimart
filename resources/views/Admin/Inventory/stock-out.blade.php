...
<div class="container-fluid px-0" style="max-width: 1400px; margin: 0 auto;" id="stock-out-page">
                ...
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="mb-0 fw-semibold d-flex align-items-center">
                            <i class="fas fa-sliders-h text-warning me-2"></i>Filter Stock Out
                        </h5>
                    ...
                    <form method="GET" action="{{ route('admin.inventory.stock-out') }}" id="filterForm">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" class="form-control border-start-0"
                                           ...
                                           value="{{ request('search') }}" id="searchInput" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="input-group">
                                    ...
                                    <select name="reason" class="form-select border-start-0">
                                        ...
                                        <option value="staff_consumption" {{ request('reason') == 'staff_consumption' ? 'selected' : '' }}>Staff Consumption</option>
                                        <option value="others" {{ request('reason') == 'others' ? 'selected' : '' }}>Others</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <!-- Apply -->
                            <div class="col-12 col-md-3">
                                <button type="submit" class="btn btn-warning w-100 fw-semibold" id="applyFilterBtn">
                                ...
                                @if (request('search'))
                                    <span class="badge bg-primary">
                                        ...
                                        <a href="{{ route('admin.inventory.stock-out', array_merge(request()->except('search', 'page'))) }}"
                                           class="text-white ms-1" title="Remove">
                                ...
                                @if (request('date_to'))
                                    <span class="badge bg-warning text-dark">
                                        ...
                                        <a href="{{ route('admin.inventory.stock-out', array_merge(request()->except('date_to', 'page'))) }}"
                                           class="text-dark ms-1" title="Remove">
                                            <i class="fas fa-times"></i>
                                        </a>
                                    </span>
                                @endif
    ...
    <!-- Transactions Table -->
    <div class="row mx-0 px-3 px-md-4" id="transactionsTableContainer">
        <div class="col-12">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                        ...
                        <div>
                            <form method="GET" action="{{ route('admin.inventory.stock-out') }}" id="perPageForm" class="d-inline">
                                @foreach (request()->except('per_page', 'page') as $key => $value)
                                    ...
                                    @endif
                                @endforeach
                                <select name="per_page" class="form-select form-select-sm" style="width: 130px;" onchange="this.form.submit()">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end px-4">
                                        <div class="d-flex gap-1 justify-content-end">
                                            ...
                                            <button class="btn btn-sm btn-outline-danger" onclick="voidTransaction({{ $transaction->id }}, '{{ addslashes($transaction->product->product_name ?? '') }}', {{ $transaction->quantity }})" title="Void transaction">
...
<!-- New Stock Out Modal -->
<div class="modal fade" id="newStockOutModal" aria-labelledby="newStockOutModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg overflow-hidden" style="border-radius: 20px;">
            <!-- Modal Header (No circle icon) -->
            ...
            <form id="stockOutForm" method="POST" action="{{ route('admin.inventory.process-stock-out') }}">
                ...
                <div class="modal-body p-4 bg-white">
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-bold small text-muted text-uppercase mb-1" for="authorizedBy">Authorized By <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0"><i class="fas fa-user-shield text-muted"></i></span>
                                <input type="text" name="authorized_by" class="form-control border-start-0" id="authorizedBy" value="{{ auth()->user()->name }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="metric-input-card-out border rounded-4 p-3 h-100">
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    submitBtn.prop('disabled', false).html('<i class="fas fa-check me-1"></i> Process Stock Out');
                }
            },
            error: function(xhr) {
