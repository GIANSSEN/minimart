...
<div class="container-fluid px-0">
    ...
    <div class="row mx-0 g-2 g-md-3 mb-4 px-3 px-md-4" id="statsContainer">
        ...
        <div class="col-6 col-md-3">
            <div class="stat-card-modern p-3 h-100 d-flex align-items-center">
                <div class="d-flex align-items-center gap-3 w-100 mb-0">
                    ...
                    <div class="min-width-0">
                        ...
                        <span class="stat-value fw-bold h3 mb-0 {{ $currentQty <= ($product->stock->min_quantity ?? 10) ? 'text-danger' : '' }}">
            ...
            <div class="stat-card-modern p-3 h-100 d-flex align-items-center">
                <div class="d-flex align-items-center gap-3 w-100 mb-0">
                    ...
                    <div class="min-width-0">
                        ...
                        <span class="stat-value fw-bold h3 mb-0 mb-0">
                    ...
                    <div class="min-width-0">
                        ...
                        @php 
                            $todayIn = $transactions->where('type', 'in')
                                ...
                                ->sum('quantity');
                        @endphp
                        <span class="stat-value fw-bold h3 mb-0 mb-0">{{ number_format($todayIn) }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="stat-card-modern p-3 h-100 d-flex align-items-center">
                <div class="d-flex align-items-center gap-3 w-100 mb-0">
                    ...
                    <div class="min-width-0">
                        ...
                        <span class="stat-value fw-bold h3 mb-0 mb-0" style="font-size: 1.2rem;">
            ...
            <div class="stat-card-modern p-3 h-100 d-flex align-items-center">
                <div class="d-flex align-items-center gap-3 w-100 mb-0">
                    ...
                    <div class="min-width-0">
                        ...
                        <span class="stat-value fw-bold h3 mb-0">{{ $transactions->total() }}</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="min-width-0">
                        ...
                        @php 
                            $todayInGlobal = \App\Models\StockTransaction::where('type', 'in')
                                ...
                                ->sum('quantity');
                        @endphp
                        <span class="stat-value fw-bold h3 mb-0">{{ number_format($todayInGlobal) }}</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="min-width-0">
                        ...
                        @php 
                            $todayOutGlobal = \App\Models\StockTransaction::where('type', 'out')
                                ...
                                ->sum('quantity');
                        @endphp
                        <span class="stat-value fw-bold h3 mb-0">{{ number_format($todayOutGlobal) }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="stat-card-modern p-3 h-100 d-flex align-items-center">
                <div class="d-flex align-items-center gap-3 w-100 mb-0">
                    ...
                    <div class="min-width-0">
                        ...
                        <span class="stat-value fw-bold h3 mb-0" style="font-size: 1.2rem;">
        ...
        Swal.fire({
            ...
            html: `
                <div class="text-start p-2">
                    <p class="mb-2"><i class="fas fa-info text-primary me-2"></i><strong>Status:</strong> <span class="badge bg-success bg-opacity-10 text-success">Verified</span></p>
