        ...
        <div class="col-12 px-0">
            <div class="modern-header-enhanced d-flex flex-wrap align-items-center justify-content-between gap-3 py-3 px-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="fw-bold mb-0" style="font-size: clamp(1.5rem, 4vw, 1.8rem);">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    @endif
                    <a href="{{ route('admin.inventory.export-history', request()->all()) }}" class="btn btn-outline-secondary" title="Export History">
                        <i class="fas fa-download me-2"></i>Export
                    </a>
                    @if(isset($product) && $product)
                        <a href="{{ route('admin.inventory.all-history') }}" class="btn btn-secondary">
                            <i class="fas fa-arrow-left me-2"></i>All History
                        </a>
                    @else
