        ...
        <div class="col-12 px-0">
            <div class="modern-header d-flex flex-wrap align-items-center justify-content-between gap-3 py-3 px-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="fw-bold mb-0" style="font-size: clamp(1.5rem, 4vw, 1.8rem);">Inventory Summary</h1>
                        <p class="text-muted mb-0 mt-2">Overview of your inventory value and distribution</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @forelse($summary['by_category'] as $item)
                                <tr>
