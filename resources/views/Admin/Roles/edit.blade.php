...
@section('title', 'Edit Role - CJ\'s Minimart')
        ...
        <div class="col-12 px-0">
            <div class="modern-header d-flex flex-wrap align-items-center justify-content-between gap-3 py-3 px-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="fw-bold mb-0" style="font-size: clamp(1.5rem, 4vw, 1.8rem);">Edit Role</h1>
                        <p class="text-muted mb-0">Editing: <span class="fw-semibold">{{ $role->name }}</span></p>
                    </div>
                </div>
        ...
        <div class="col-12 px-0">
            <div class="alert alert-warning d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="mb-0">This is a system role. Some properties cannot be modified.</p>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                                   ...
                                                   {{ in_array($role->slug, ['admin', 'supervisor', 'cashier']) ? 'readonly' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control bg-white" value="{{ $role->slug }}" readonly>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                                      rows="3" placeholder="Describe the role's purpose...">{{ old('description', $role->description) }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if ($role->slug === 'admin')
                                                <small class="text-muted">Admin role cannot be deactivated</small>
                                            @endif
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Users Assigned</label>
...
<style>
    ...
    .header-icon {
        ...
        box-shadow: 0 8px 15px rgba(240, 147, 251, 0.25);
        flex-shrink: 0;
        z-index: 2;
    }
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const groups = {};
        document.querySelectorAll('.permission-checkbox').forEach(checkbox => {
            const group = checkbox.className.match(/group-(\S+)/)[1];
        ...
        Object.keys(groups).forEach(group => {
            const groupCheckbox = document.getElementById(`group_${group}`);
            if (groupCheckbox) {
                const allChecked = groups[group].every(cb => cb.checked);
                groupCheckbox.checked = allChecked;
            }
        });
    });
