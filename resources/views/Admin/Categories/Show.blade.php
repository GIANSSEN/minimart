                                        ...
                                        <td class="ps-4 py-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-muted" style="font-size: 0.75rem;">{{ $product->product_code }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 24px; overflow: hidden;">
            <div class="modal-header border-0 bg-white px-4 py-4">
                <div class="d-flex align-items-center gap-3">
                    <div class="bg-primary bg-opacity-10 p-3 rounded-3 text-primary d-flex align-items-center justify-content-center" style="width: 48px; height: 48px;">
            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="icon" value="{{ old('icon', $category->icon ?: 'fa-folder') }}">
                <input type="hidden" name="color" value="{{ old('color', $category->color ?: '#3B82F6') }}">
                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div class="form-floating">
                            <input type="text" name="category_name" id="catName"
                                   class="form-control bg-light border-0 @error('category_name') is-invalid @enderror"
                                   value="{{ old('category_name', $category->category_name) }}"
                                   required placeholder="Category Name" style="border-radius: 12px;">
                        ...
                        <div class="form-floating">
                            <textarea name="description" id="desc"
                                      ...
                                      style="border-radius: 12px; height: 110px;">{{ old('description', $category->description) }}</textarea>
