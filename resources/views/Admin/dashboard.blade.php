            ...
            <div class="feed-body" id="approvals-container">
                ...
                <div class="user-request-item" id="dash-user-{{ $user->id }}">
                    ...
                    <div class="user-actions-mini">
                        <button class="btn-mini-approve" onclick="quickApprove({{ $user->id }}, '{{ $user->full_name }}')" title="Approve">
                            <i class="fas fa-check"></i>
                        </button>
                        <button class="btn-mini-reject" onclick="quickReject({{ $user->id }}, '{{ $user->full_name }}')" title="Reject">
...
.period-switcher { background: #f1f5f9; padding: 0.35rem; border-radius: 12px; display: flex; gap: 0.25rem; }
.period-btn { padding: 0.5rem 1rem; border: none; background: transparent; border-radius: 8px; font-size: 0.85rem; font-weight: 700; color: #64748b; cursor: pointer; transition: all 0.2s; }
.period-btn.active { background: #fff; color: var(--primary-indigo); box-shadow: 0 4px 10px rgba(0,0,0,0.05); }
...
.btn-mini-approve, .btn-mini-reject {
    width: 32px; height: 32px; border: none; border-radius: 8px;
    display: flex; align-items: center; justify-content: center;
    cursor: pointer; transition: all 0.2s;
}
.btn-mini-approve { background: #10b981; color: #fff; }
.btn-mini-reject { background: #fee2e2; color: #ef4444; }
.btn-mini-approve:hover { transform: scale(1.1); }
.btn-mini-reject:hover { background: #ef4444; color: #fff; }
