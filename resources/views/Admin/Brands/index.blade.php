...
<div class="brands-page">
    ...
    <div class="brands-header">
        <div class="brands-header-left">
            <div class="brands-header-icon">
                <i class="fas fa-trademark"></i>
            </div>
            <div>
                <h1 class="brands-title">Brands</h1>
                <p class="brands-subtitle">Manage product brands and manufacturers</p>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr data-brand-id="{{ $brand->id }}">
                        ...
                        <td data-label="Actions">
                            <div class="brands-action-group">
                                <a href="{{ route('admin.brands.show', $brand->id) }}"
                                   class="brands-action-btn btn-view" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.brands.edit', $brand->id) }}"
                                   class="brands-action-btn btn-edit" title="Edit Brand">
                                    <i class="fas fa-edit"></i>
                                </a>
                                @if($brand->products_count == 0)
                                <button type="button"
                                        class="brands-action-btn btn-delete"
                                ...
                                @else
                                <button type="button"
                                        class="brands-action-btn btn-delete-disabled"
...
.brands-action-btn:hover { transform: translateY(-2px); }
.btn-view:hover  { background: #dbeafe; border-color: #93c5fd; color: #2563eb; }
