        ...
        <div class="col-12 px-0">
            <div class="modern-header-enhanced d-flex flex-wrap align-items-center justify-content-between gap-3 py-3 px-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="fw-bold mb-0" style="font-size: clamp(1.5rem, 4vw, 1.8rem);">Activity Logs</h1>
                        <p class="text-muted mb-0 mt-2">Track and monitor all system activities and user actions</p>
                    </div>
                </div>
                <div class="d-flex gap-2 flex-wrap">
                    <button class="btn btn-outline-secondary" onclick="refreshLogs()" title="Refresh logs" aria-label="Refresh activity logs">
                        <i class="fas fa-sync-alt me-2"></i><span class="d-none d-sm-inline">Refresh</span>
                    </button>
                    <button class="btn btn-success" onclick="exportLogs()" title="Export logs" aria-label="Export activity logs">
                        <i class="fas fa-download me-2"></i><span class="d-none d-sm-inline">Export</span>
                    </button>
                    <button type="button" class="btn btn-danger" onclick="confirmClearAll()" title="Clear all logs" aria-label="Clear all activity logs">
                        <i class="fas fa-trash me-2"></i><span class="d-none d-sm-inline">Clear All</span>
                    </button>
                </div>
            </div>
        </div>
