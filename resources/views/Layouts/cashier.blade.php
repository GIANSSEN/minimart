            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    <button class="btn nav-user-info dropdown-toggle text-white border-0 d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->full_name ?? 'Cashier') }}&background=F97316&color=fff&size=32" 
                             class="rounded-circle border border-2 border-white" width="30" height="30">
